# SLIM Point-to-Point Demo — Odd/Even

Cross-language point-to-point demo: **Bob** (Go) sends random numbers to **Alice** (.NET), who replies with "odd" or "even". Showcases SLIM multi-language bindings.
